...
func (a *App) HandlePostInspection(c echo.Context) error {
	...
	inspection.IsExternalDamagePresent.Bool = parseCheckbox(c.FormValue("isExternalDamagePresent"))
	...
	fmt.Println("IsExternalDamagePresent:", inspection.IsExternalDamagePresent.Bool)
